  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
              ...
              <div className="lg:flex lg:items-center">
                ...
                >
                  ...
                  <p className="text-lg lg:text-xl text-slate-600 mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    ...
                    mengembangkan ide-ide brilian di bidang kreativitas,
        ...
        {/* ====================================================================== */}
        <motion.section variants={containerVariants} className="py-20 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div variants={itemVariants} className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 leading-relaxed max-w-3xl mx-auto">
                Temukan artikel-artikel inspiratif, panduan praktis, dan insight
                terkini dari komunitas kreatif UTY Creative Hub.
              </p>
            </motion.div>
