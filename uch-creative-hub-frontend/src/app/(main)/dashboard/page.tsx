      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3 lg:gap-8">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            {/* Panel Manajemen untuk Admin atau Author */}
            {(user?.role === "ADMIN" || user?.role === "AUTHOR") && (
              <Card className="shadow-lg rounded-xl lg:rounded-2xl overflow-hidden bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-100">
                <CardHeader className="p-4 lg:p-6">
                  <div className="flex items-center">
                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl bg-purple-100 flex items-center justify-center mr-3 lg:mr-4">
                      <UserCog className="w-5 h-5 lg:w-6 lg:h-6 text-purple-600" />
                    </div>
                    <div>
                      {/* Title dan Subtitle disesuaikan */}
                      <CardTitle className="text-lg lg:text-xl text-gray-900">Panel Manajemen</CardTitle>
                      <CardDescription className="text-sm lg:text-base text-gray-600">
                        Kelola sistem sesuai peran Anda
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-4 lg:p-6">
                  <p className="text-xs lg:text-sm text-gray-600 mb-4 lg:mb-6">
                    Akses fitur manajemen untuk mengelola data booking atau konten artikel.
                  </p>
                  <div className="space-y-3 lg:space-y-4">
                    {/* Tombol Panel Booking hanya untuk ADMIN */}
                    {user?.role === "ADMIN" && (
                    ...
                    {/* Tombol Kelola Artikel untuk ADMIN dan AUTHOR */}
